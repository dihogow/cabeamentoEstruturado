...
\author{André, Diogo Witt, Jedielson, Paulo }  	% Author name goes here
...
\initial{E}\textbf{
	O presente projeto visa apresentar uma restruturação fictícia na infraestrutura baseada no ambiente real do Instituto Ambiental do Paraná

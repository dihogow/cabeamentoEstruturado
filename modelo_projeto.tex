...
\author{André Luis Finatto, Diogo Witt, Jedielson, Paulo }  	% Author name goes here
...
\initial{E}\textbf{O presente projeto visa apresentar uma reestruturação fictícia na infraestrutura baseada no ambiente real do Instituto Ambiental do Paraná.
	O Projeto aborda o levantamento da planta física, elaboração da planta lógica e equipamentos passivos da rede.}

%	ste modelo exemplifica como um projeto de cabeamento estruturado deve ser elaborado. No projeto real,
...
\subsection{Usuários}
O ambiente possui um total de 33 usuários
...
O prédio é formado por 2 andares. No térreo estão a Recepção, Licenciamento Florestal, Fiscalização, Arquivo e Combustível.

No primeiro andar estão a Chefia, Arquivo, Licenciamento Industrial, Administrativo e Escritório Regional.
...
\begin{figure}
	\centering
	\caption[Planta Baixa 1 Andar]{}
	\label{fig:1andara4}
	\includegraphics{1andarA4}
\end{figure}
...
%inicio dos comandos para criar uma nova pagina 
\clearpage
